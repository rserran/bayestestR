...
[`library`](https://rdrr.io/r/base/library.html)`(`[`bayestestR`](https://easystats.github.io/bayestestR/)`)`` `[`library`](https://rdrr.io/r/base/library.html)`(`[`mediation`](https://imai.princeton.edu/projects/mechanisms.html)`)`` `[`library`](https://rdrr.io/r/base/library.html)`(`[`brms`](https://github.com/paul-buerkner/brms)`)`` `[`library`](https://rdrr.io/r/base/library.html)`(`[`rstanarm`](https://mc-stan.org/rstanarm/)`)`` `` ``# load sample data`` `[`data`](https://rdrr.io/r/utils/data.html)`(``jobs``)`` `` `[`set.seed`](https://rdrr.io/r/base/Random.html)`(``123``)`` ``# linear models, for mediation analysis`` ``b1`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``job_seek`` ``~`` ``treat`` ``+`` ``econ_hard`` ``+`` ``sex`` ``+`` ``age``, data ``=`` ``jobs``)`` ``b2`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``depress2`` ``~`` ``treat`` ``+`` ``job_seek`` ``+`` ``econ_hard`` ``+`` ``sex`` ``+`` ``age``, data ``=`` ``jobs``)`` `` ``# mediation analysis, for comparison with brms`` ``m1`` ``<-`` `[`mediate`](https://rdrr.io/pkg/mediation/man/mediate.html)`(``b1``, ``b2``, sims ``=`` ``1000``, treat ``=`` ``"treat"``, mediator ``=`` ``"job_seek"``)`

`# Fit Bayesian mediation model in brms`` ``f1`` ``<-`` `[`bf`](https://paulbuerkner.com/brms/reference/brmsformula.html)`(``job_seek`` ``~`` ``treat`` ``+`` ``econ_hard`` ``+`` ``sex`` ``+`` ``age``)`` ``f2`` ``<-`` `[`bf`](https://paulbuerkner.com/brms/reference/brmsformula.html)`(``depress2`` ``~`` ``treat`` ``+`` ``job_seek`` ``+`` ``econ_hard`` ``+`` ``sex`` ``+`` ``age``)`` ``m2`` ``<-`` `[`brm`](https://paulbuerkner.com/brms/reference/brm.html)`(``f1`` ``+`` ``f2`` ``+`` `[`set_rescor`](https://paulbuerkner.com/brms/reference/brmsformula-helpers.html)`(``FALSE``)``, data ``=`` ``jobs``, refresh ``=`` ``0``)`

`# Fit Bayesian mediation model in rstanarm`` ``m3`` ``<-`` `[`stan_mvmer`](https://mc-stan.org/rstanarm/reference/stan_mvmer.html)`(`` `` `[`list`](https://rdrr.io/r/base/list.html)`(`` `` ``job_seek`` ``~`` ``treat`` ``+`` ``econ_hard`` ``+`` ``sex`` ``+`` ``age`` ``+`` ``(``1`` ``|`` ``occp``)``,`` `` ``depress2`` ``~`` ``treat`` ``+`` ``job_seek`` ``+`` ``econ_hard`` ``+`` ``sex`` ``+`` ``age`` ``+`` ``(``1`` ``|`` ``occp``)`` `` ``)``,`` `` data ``=`` ``jobs``,`` `` refresh ``=`` ``0`` ``)`
...
`# for brms`` `[`mediation`](https://easystats.github.io/bayestestR/reference/mediation.md)`(``m2``)`` ``#> # Causal Mediation Analysis for Stan Model`` ``#> `` ``#> Treatment: treat`` ``#> Mediator : job_seek`` ``#> Response : depress2`` ``#> `` ``#> Effect | Estimate | 95% ETI`` ``#> ----------------------------------------------------`` ``#> Direct Effect (ADE) | -0.040 | [-0.124, 0.046]`` ``#> Indirect Effect (ACME) | -0.015 | [-0.041, 0.008]`` ``#> Mediator Effect | -0.240 | [-0.294, -0.185]`` ``#> Total Effect | -0.055 | [-0.145, 0.034]`` ``#> `` ``#> Proportion mediated: 28.14% [-181.46%, 237.75%]`` `` ``# for rstanarm`` `[`mediation`](https://easystats.github.io/bayestestR/reference/mediation.md)`(``m3``)`` ``#> # Causal Mediation Analysis for Stan Model`` ``#> `` ``#> Treatment: treat`` ``#> Mediator : job_seek`` ``#> Response : depress2`` ``#> `` ``#> Effect | Estimate | 95% ETI`` ``#> ----------------------------------------------------`` ``#> Direct Effect (ADE) | -0.040 | [-0.129, 0.048]`` ``#> Indirect Effect (ACME) | -0.018 | [-0.042, 0.006]`` ``#> Mediator Effect | -0.241 | [-0.296, -0.187]`` ``#> Total Effect | -0.057 | [-0.151, 0.033]`` ``#> `` ``#> Proportion mediated: 30.59% [-221.09%, 282.26%]`
...
[`summary`](https://rdrr.io/r/base/summary.html)`(``m1``)`` ``#> `` ``#> Causal Mediation Analysis `` ``#> `` ``#> Quasi-Bayesian Confidence Intervals`` ``#> `` ``#> Estimate 95% CI Lower 95% CI Upper p-value`` ``#> ACME -0.0157168 -0.0387462 0.0075162 0.192`` ``#> ADE -0.0438229 -0.1315386 0.0384077 0.348`` ``#> Total Effect -0.0595397 -0.1530295 0.0235004 0.206`` ``#> Prop. Mediated 0.2136537 -2.0276750 2.6953662 0.322`` ``#> `` ``#> Sample Size Used: 899 `` ``#> `` ``#> `` ``#> Simulations: 1000`` `` `[`mediation`](https://easystats.github.io/bayestestR/reference/mediation.md)`(``m2``, ci ``=`` ``0.95``)`` ``#> # Causal Mediation Analysis for Stan Model`` ``#> `` ``#> Treatment: treat`` ``#> Mediator : job_seek`` ``#> Response : depress2`` ``#> `` ``#> Effect | Estimate | 95% ETI`` ``#> ----------------------------------------------------`` ``#> Direct Effect (ADE) | -0.040 | [-0.124, 0.046]`` ``#> Indirect Effect (ACME) | -0.015 | [-0.041, 0.008]`` ``#> Mediator Effect | -0.240 | [-0.294, -0.185]`` ``#> Total Effect | -0.055 | [-0.145, 0.034]`` ``#> `` ``#> Proportion mediated: 28.14% [-181.46%, 237.75%]`` `` `[`mediation`](https://easystats.github.io/bayestestR/reference/mediation.md)`(``m3``, ci ``=`` ``0.95``)`` ``#> # Causal Mediation Analysis for Stan Model`` ``#> `` ``#> Treatment: treat`` ``#> Mediator : job_seek`` ``#> Response : depress2`` ``#> `` ``#> Effect | Estimate | 95% ETI`` ``#> ----------------------------------------------------`` ``#> Direct Effect (ADE) | -0.040 | [-0.129, 0.048]`` ``#> Indirect Effect (ACME) | -0.018 | [-0.042, 0.006]`` ``#> Mediator Effect | -0.241 | [-0.296, -0.187]`` ``#> Total Effect | -0.057 | [-0.151, 0.033]`` ``#> `` ``#> Proportion mediated: 30.59% [-221.09%, 282.26%]`
